About geodemo_zw-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geodemo_zw-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12424&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geodemo_zw-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geodemo_zw` can be installed with `conda`:
...
```
mamba install geodemo_zw
```

It is possible to list all of the versions of `geodemo_zw` available on your platform with `conda`:
...
```
mamba search geodemo_zw --channel conda-forge
```
...
mamba repoquery search geodemo_zw --channel conda-forge

# List packages depending on `geodemo_zw`:
mamba repoquery whoneeds geodemo_zw --channel conda-forge

# List dependencies of `geodemo_zw`:
mamba repoquery depends geodemo_zw --channel conda-forge
```
